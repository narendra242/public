		...
		<div class="panel panel-default">
		    ...
		    <div class="">
				<ul class="nav nav-checkout-progress list-unstyled">
                    ...
                    <hr>
                    <strong>Coupon Amount:</strong> ${{session()->get('coupon')['discount_amount']}}
                    <hr>
...
var stripe = Stripe('pk_test_51MZxymBpx4OElajx7Q07CYgRAv1xwpvCLcUphIuj0GKRvbuApq87m1EYMiwtPIIBkSyRXFw6jGRSH6ujZAu8QTUu00xrqDvFrr');
