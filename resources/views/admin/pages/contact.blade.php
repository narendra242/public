...
<td>{{ $record->phone }}</td>
<td>
<a class="btn btn-danger btn-sm" title="Delete" id="delete_single"  data-url="contact/delete" data-id="{{ $record->id }}" data-token="{{ csrf_token() }}"> <i class="typcn typcn-delete"></i></a></td>
</tr>
@endforeach
@else
<tr>
