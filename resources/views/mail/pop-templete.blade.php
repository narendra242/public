...
<h1 style="font:bold 26px Arial,sans-serif!important;color:#000000!important;margin:0;padding:0;text-align:left">Tour Enquiry from {{ $data['title'] }}</h1>
</div>
</td>
</tr>
</tbody></table>
...
This e-mail was sent from a home enquiry form <br> <a href="{{ $data['weburl'] }}" rel="nofollow" target="_blank" >{{ $data['weburl'] }}</a></p>
</div>
</td>
</tr>
</tbody></table>
